...
export default function Register() {
    return(
        <div className='relative flex items-start justify-center h-screen pt-4'>
            <div style={{ backgroundImage: `url(${bgimg})` }} className='bg-cover w-[98%] h-[50%] relative bg-center rounded-2xl'>
                ...
                <Card className='flex justify-center items-center absolute top-50 h-[614px] w-[453px]'>
                    ...
                    <CardContent>
                        <form action="" className='flex flex-col gap-5 *:text-xl'>
                            ...
                            <button className='bg-gray-700 w-full h-[45px] self-center rounded-[8px] text-white'>Register</button>
                        </form>
                    </CardContent>
                    <CardFooter>
                        <p>dont have account? <a href="login" className='text-blue-400'>Sign In</a></p>
                    </CardFooter>
                </Card>
                <Footer />
        </div>
